...
def get_args():
    ...
    parser.add_argument(
        "--all",
        action="store_true",
        help="All selections (oral, spotlight, poster) will be crawled.",
    )
    ...
    parser.add_argument(
        ...
        default=60,
        type=int,
        help="Maximum wait time (in seconds) until the page is fully loaded.",
    )
    parser.add_argument(
        "--headless", action="store_true", help="Crawl with headless mode."
    )
